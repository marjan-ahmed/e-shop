...
export const ScrollStackItem: React.FC<ScrollStackItemProps> = ({ children, itemClassName = '' }) => (
  <div
    className={`
      scroll-stack-card
      relative
      w-full sm:w-[95%] lg:w-[1155px]
      h-auto
      min-h-[350px] sm:min-h-[400px] md:min-h-[450px] lg:min-h-[409px]
      my-6 sm:my-8
      p-6 sm:p-8 md:p-10 xl:p-12
      mx-auto
      rounded-[28px] sm:rounded-[40px] xl:rounded-[46px]
      shadow-[0_6px_32px_-8px_rgba(0,0,0,0.12)]
      box-border
      origin-top
...
const ScrollStack: React.FC<ScrollStackProps> = ({
  ...
  }, [handleScroll, itemDistance, setupLenis, updateCardTransforms]);

  return (
    <div className={`relative w-full h-full ${className}`.trim()} ref={scrollerRef}>
      <div className="scroll-stack-inner pt-[20vh] px-4 md:px-10 pb-[40rem] max-w-7xl mx-auto">
        {children}
